            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Log.d(TAG, "Login apikey:" + apiKey);
                        String name = jObj.getString("name");
                        String policy = jObj.getString("policy");
                        String username = jObj.getString("username");
                        String email = jObj.getString("email");
                        String created_at = "NOW";//jObj.getString("created_at");

                        // Inserting row in users table
                        db.addUser(name, username, policy, email, apiKey, created_at);
